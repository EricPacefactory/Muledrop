...
# -*- coding: utf-8 -*-
"""
Created on Fri Jun 26 12:16:03 2020
...
class Test_Station(Reference_Station):
    ...
    def process_one_frame(self, frame, current_frame_index, current_epoch_ms, current_datetime):
        ...
        # Test just outputs counting sequences
        one_frame_result = (current_frame_index % 10, current_epoch_ms % 100)
