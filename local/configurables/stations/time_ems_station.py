...
# -*- coding: utf-8 -*-
"""
Created on Mon Jul 13 11:00:17 2020
...
class Configurable(Reference_Station):
    ...
    def setup(self, variables_changed_dict):
        ...
        # No controls, so nothing to setup
        # (Zone/Drawing isn't actually used for anything!)
    ...
    def process_one_frame(self, frame, current_frame_index, current_epoch_ms, current_datetime):
        ...
        # Store timing info for every frame
        one_frame_result = current_epoch_ms
