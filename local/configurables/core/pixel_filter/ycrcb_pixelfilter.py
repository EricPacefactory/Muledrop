...
class Pixel_Filter_Stage(Reference_Pixel_Filter):
    ...
    def __init__(self, input_wh):
        ...
        lc = self.controls_manager.new_control_group("Luma Controls")
        
        self.lum_lower = \
        lc.attach_slider("lum_lower", 
                         label = "Lower Luma", 
                         default_value = 0,
                         min_value = 0,
                         max_value = 255,
        ...
        rc = self.controls_manager.new_control_group("Red Chroma Controls")
        
        self.chr_lower = \
        rc.attach_slider("chr_lower", 
        ...
        bc = self.controls_manager.new_control_group("Blue Chroma Controls")
        
        self.chb_lower = \
        bc.attach_slider("chb_lower", 
