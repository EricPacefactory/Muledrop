...
# -*- coding: utf-8 -*-
"""
Created on Wed May 27 14:52:46 2020
...
class FG_Extractor_Stage(Reference_FG_Extractor):
    ...
    def setup(self, variables_changed_dict):
        ...
        # Set up frame decks & update due to scaling changes, if needed
    ...
    def process_current_frame(self, frame):
        ...
        frame = cv2.Canny(frame, self.low_threshold, self.high_threshold)
        
        # Apply pre-difference morphology
...
if __name__ == "__main__":
    ...
    example = FG_Extractor_Stage((500,500))
    print("", "Initial configuration:", example, sep="\n")
    example.reconfigure(setup_data_dict = {"blur_size": 77})
