...
class Controls_Specification:
    ...
    def get_full_variable_name_list(self, saveables_only = True):
        
        # For clarity
        save_everything = (not saveables_only)
        
        # Loop over every control group and get every variable name
        variable_name_list = []
        for each_group_name, each_control_list in self.control_group_dict.items():
            ...
            for each_control_spec in each_control_list:
                ...
                variable_name = each_control_spec["variable_name"]
    ...
    def get_drawing_specification(self, variable_name):
        ...
        return self.drawing_control_dict.get(variable_name)
    ...
    def to_json(self):
        ...
        The output takes on the following format:
            control_groups_list = [{"group_name": "...", "control_list": [{<control_spec>}, {<control_spec>}, {...}]}]
    ...
    def attach_drawing(self, variable_name, *, default_value, 
        ...
        safe_default = safeify_drawing_default_values(input_values.get(default_key))
    ...
    def _add_new_control(self, control_type, **control_spec):
        ...
        self.control_group_dict.get(group_name).append(control_info)
