...
def build_rule_config_folder_path(cameras_folder_path, camera_select, *path_joins):
    return build_after_database_configs_folder_path(cameras_folder_path, camera_select, "rules", *path_joins)
    
# .....................................................................................................................

def build_rule_config_file_path(cameras_folder_path, camera_select, rule_name):
    save_name = create_rule_config_file_name(rule_name)
    return build_rule_config_folder_path(cameras_folder_path, camera_select, save_name)

# .....................................................................................................................

def build_rule_adb_info_report_path(cameras_folder_path, camera_select, *path_joins):
    return build_after_database_report_path(cameras_folder_path, camera_select, "rule_info", *path_joins)

# .....................................................................................................................

def build_rule_adb_metadata_report_path(cameras_folder_path, camera_select, *path_joins):
    return build_after_database_report_path(cameras_folder_path, camera_select, "rules", *path_joins)
...
def save_rule_info(cameras_folder_path, camera_select, rule_refs_dict, saving_enabled):
    ...
    for each_rule_name, each_rule_ref in rule_refs_dict.items():
        ...
        save_path = build_rule_adb_info_report_path(cameras_folder_path, camera_select)
...
def save_rule_report_data(cameras_folder_path, camera_select, rule_name, 
    ...
    save_file_path = build_rule_adb_metadata_report_path(cameras_folder_path, camera_select, rule_name)
...
def path_to_configuration_file(rule_name, configurable_ref):
    ...
    return build_rule_config_file_path(cameras_folder_path, camera_select, rule_name)

# .....................................................................................................................

def load_all_rule_configs(cameras_folder_path, camera_select, target_rule_type = None):
    
    # First get pathing to config folder, where all rule configs live
    rule_config_folder_path = build_rule_config_folder_path(cameras_folder_path, camera_select)
...
def load_rule_config(cameras_folder_path, camera_select, rule_name):
...
def select_rule_to_load(rule_ref):
    ...
    all_rule_configs = load_all_rule_configs(cameras_folder_path, camera_select, target_rule_type = rule_type)
