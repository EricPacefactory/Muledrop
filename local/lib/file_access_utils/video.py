...
def build_videos_folder_path(cameras_folder_path, camera_select, *path_joins):
    return build_resources_folder_path(cameras_folder_path, camera_select, "videos", *path_joins)

# .....................................................................................................................

def build_video_files_dict_path(cameras_folder_path, camera_select):
    return build_videos_folder_path(cameras_folder_path, camera_select, "video_files_record.json")

# .....................................................................................................................

def build_rtsp_file_path(cameras_folder_path, camera_select):
...
def get_video_names_and_paths_lists(cameras_folder_path, camera_select, error_if_no_videos = True):
    ...
    videos_folder_path = build_videos_folder_path(cameras_folder_path, camera_select)
...
def load_video_files_dict(cameras_folder_path, camera_select):
    ...
    video_files_dict_path = build_video_files_dict_path(cameras_folder_path, camera_select)
...
def save_video_files_dict(cameras_folder_path, camera_select, new_video_files_dict):
...
def add_video_to_files_dict(cameras_folder_path, camera_select, new_video_path,
                            new_video_name = None,
    ...
    Inputs:
        cameras_folder_path, camera_select -> (Strings) Pathing to a camera
...
def rename_video_in_files_dict(cameras_folder_path, camera_select, old_video_name, new_video_name):
...
def delete_video_in_files_dict(cameras_folder_path, camera_select, video_name_to_delete):
    ...
    is_local_path = check_path_is_local(cameras_folder_path, camera_select,  deleted_video_full_path)
...
def change_video_start_datetime(cameras_folder_path, camera_select, video_name, new_start_datetime):
...
def change_video_timelapse_factor(cameras_folder_path, camera_select, video_name, new_timelapse_factor):
...
def copy_video_file_local(cameras_folder_path, camera_select, remote_file_path, print_feedback = False):
    
    # Make sure the 'remote' file isn't actually local
    is_local = check_path_is_local(cameras_folder_path, camera_select, remote_file_path)
    if is_local:
        if print_feedback:
            print("",
                  "File is local",
...
def check_path_is_local(cameras_folder_path, camera_select, video_path):
...
def video_info_from_name(cameras_folder_path, camera_select, video_select):
    ...
    is_local_entry = check_entry_is_local(expanded_path)
    if is_local_entry:
        expanded_path = build_videos_folder_path(cameras_folder_path, camera_select, expanded_path)        
...
def load_rtsp_config(cameras_folder_path, camera_select, rtsp_filename = "rtsp.json"):
    ...
    rtsp_file_path = build_videos_folder_path(cameras_folder_path, camera_select, rtsp_filename)
...
def save_rtsp_config(cameras_folder_path, camera_select, new_rtsp_config, rtsp_filename = "rtsp.json"):
...
def check_valid_rtsp_ip(cameras_folder_path, camera_select):
...
def load_playback_settings(cameras_folder_path, camera_select, video_select, 
    ...
    # Build pathing to the playback settings file
    load_path = build_videos_folder_path(cameras_folder_path, camera_select, settings_filename)
...
def save_playback_settings(cameras_folder_path, camera_select, video_select, 
    ...
    # Build pathing to the playback settings file
    save_path = build_videos_folder_path(cameras_folder_path, camera_select, settings_filename)
