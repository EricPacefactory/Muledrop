...
# -*- coding: utf-8 -*-
"""
Created on Wed Jul  3 12:59:45 2019
...
def build_object_metadata_folder_path(cameras_folder, camera_select, user_select, task_select):
    object_metadata_folder_name = "objects-({})".format(task_select)
    return build_metadata_report_path(cameras_folder, camera_select, user_select, object_metadata_folder_name)

# .....................................................................................................................

def build_objdata_config_file_path(cameras_folder, camera_select, user_select, 
                                   config_file_name = "object_metadata.json"):
...
def create_default_objdata_config(project_root_path, user_folder_path):
...
def load_objdata_config(cameras_folder, camera_select, user_select, task_select, rule_name):
    
    # Build load pathing & load the object metadata saving config
    config_file_path = build_objdata_config_file_path(cameras_folder, camera_select, user_select)
    objdata_config_data = load_with_error_if_missing(config_file_path)
    
    return objdata_config_data

# .....................................................................................................................
    
def save_objdata_config(cameras_folder, camera_select, user_select, 
