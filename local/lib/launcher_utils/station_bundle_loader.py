...
'''
STOPPED HERE
- NEED TO SET UP MORE STATION CONFIGS (AVG GRAY, AVG RGB ETC)
- NEED TO SET UP BASIC CONFIG UTILS
- THEN NEED TO TRY SAVING DATA AND POSTING TO DB?
    - WILL NEED TO SET UP ROUTING
    - SET UP DELETION + ADD TO AUTO-DELETE
- MAY WANT TO SET UP 'STATION INFO' TYPE OUTPUT AS WELL
    - WOULD INCLUDE STATION CONFIGS?
    - ALSO INCLUDE DESCRIPTION OF STATION OUTPUTS/TYPE (MAY BE USEFUL FOR FUTURE PARSING?)
'''
'''
STOPPED HERE
- NEED CONTINUE SETTING UP STATION BUNDLER
- THEN NEED TO ADD TO CONFIG LOADER
- THEN NEED TO TEST WITH DUMMY CONFIG FILES
- REALLY NEED TO CLEAN UP IMPORTING & PATHING FUNCTIONS SOME MORE!
'''
