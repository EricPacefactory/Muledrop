...
def load_object_metadata(object_id, task_select, obj_metadata_paths_by_task):
    load_path = obj_metadata_paths_by_task.get(task_select).get(object_id)
    return load_json(load_path)

# .....................................................................................................................

def load_snapshot_metadata(snap_count, snap_count_paths_lut):
    snap_path = snap_count_paths_lut.get(snap_count)
...
def load_snapshot_image(snapshot_image_folder_path, snapshot_metadata):
    ...
    snap_name = snapshot_metadata.get("snapshot_name")
...
for each_task, each_labelling_dict in labelling_results_dict.items():
    ...
    for each_obj_id, each_label_idx in each_labelling_dict.items():
        ...
        label_str = label_lut_dict.get(each_label_idx)
        ...
        obj_first_frame_idx = obj_md.get("timing").get("first_frame_index")
        obj_last_frame_idx = obj_md.get("timing").get("last_frame_index")
        obj_track_data = obj_md.get("tracking")
        obj_hulls = obj_track_data.get("hull")
        obj_num_samples = obj_md.get("num_samples")
        
        # Get bounding snapshot indices
        first_snap_count = obj_md.get("snapshots").get("first").get("snapshot_count")
        last_snap_count = obj_md.get("snapshots").get("last").get("snapshot_count")
        ...
        for snap_count in range(first_snap_count, 1 + last_snap_count):
            ...
            snap_frame_idx = snap_md.get("snapshot_frame_index")
