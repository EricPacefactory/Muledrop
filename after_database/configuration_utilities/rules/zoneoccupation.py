...
from local.configurables.after_database.rules.zoneoccupation_rule import Configurable
...
camera_select, camera_path = selector.camera(location_select, debug_mode = enable_debug_mode)
