    ...
    def datasets(self, training_split = 0.75, validiation_split = 0.20, testing_split = 0.05,
        ...
        for each_dataset, each_max_class_count in max_class_count.items():
            ...
            for each_class, each_dataset_dict in split_lists_by_class.items():
                data_list = each_dataset_dict[each_dataset]
        ...
        train_data_list = self._shuffle_data(dataset_lists["train"], shuffle_results)
        valid_data_list = self._shuffle_data(dataset_lists["valid"], shuffle_results)
        test_data_list = self._shuffle_data(dataset_lists["test"], shuffle_results)
...
base_pp = "~/Desktop/pytorch_saved_models/full_sn_112x112.pt"
pp = os.path.expanduser(base_pp)
