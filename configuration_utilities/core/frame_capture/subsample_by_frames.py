...
# -*- coding: utf-8 -*-
"""
Created on Tue May 28 17:01:29 2019
...
loader = Reconfigurable_Core_Stage_Loader("frame_capture", "subsample_by_frames_framecapture", "Frame_Capture_Stage")
configurable_ref = loader.setup_all(__file__)

# Set up object to handle all video processing
main_process = \
Reconfigurable_Video_Loop(loader,
                          ordered_display_list = [Input_Display(1, 1, 3)])
