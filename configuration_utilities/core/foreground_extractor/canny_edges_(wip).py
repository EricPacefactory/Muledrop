...
from local.lib.ui_utils.display_specification import Input_Display, Binary_Display
...
target_script_name = "cannyedges_fgextractor"
...
Reconfigurable_Video_Loop(loader,
                          ordered_display_list = [Input_Display(0, 2, 2, drawing_json = zone_drawing_spec),
