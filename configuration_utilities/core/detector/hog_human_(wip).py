...
# -*- coding: utf-8 -*-
"""
Created on Tue Aug 18 10:44:07 2020
...
from local.configurables.core.detector.hog_human_detector import draw_detections
...
target_script_name = "hog_human_detector"
...
Reconfigurable_Video_Loop(loader,
                          ordered_display_list = [Detection_Display(3, 3, 2,
                                                                    window_name = "Draw Ignore Zones",
                                                                    drawing_json = ignore_drawing_spec),
                                                  Custom_Detections_Display(2, 3, 2)])
