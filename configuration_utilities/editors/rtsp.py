...
def _rtsp_input_select():
    ...
    rtspstring_option = "Enter RTSP string directly"
    info_option = "View RTSP info"
    test_option = "Test RTSP connection"
    input_options_prompt = [components_option, rtspstring_option, info_option, test_option]
    ...
    lut_out = {"components": (entry_select == components_option),
               "rtspstring": (entry_select == rtspstring_option),
...
script_args = parse_editor_args(custom_arguments, show_user = False, show_video = False)
